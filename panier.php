...
<head>
 ...
 <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
  ...
  <!-- My design-->
 <link rel="stylesheet" href="../mon_site/CSS/Panier.css">
 <!--My design -->
...
<br/>
<br/>
    <div class="container-fluid w-100 h-100  Tableau">
      ...
      <script>
          $(function(){
            $(".header-class").css("background","linear-gradient(to bottom, rgba(250, 114, 114, 1), rgba(6, 6, 237, 0.4))");
          });
      </script>
