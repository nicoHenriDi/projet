...
<!--Navbar -->
<nav class="mb-1 navbar fixed-top navbar-expand-lg navbar-dark shadow-5-strong px-4 header-class" style="position:fixed;padding:0;">
  <a class="navbar-brand" href="../mon_site/Natu_fi_acceuil.php"><i>Natu'fi</i></a>
  <button class="navbar-toggler m-0" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent-333"
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link text-white" href="../mon_site/Natu_fi_acceuil.php">Home
      ...
      <li class="nav-item">
        <a class="nav-link text-white" href="Contactez-nous.php">Contactez nous</a>
      </li>
    </ul>
